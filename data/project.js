const projects = [
  {
    ...
    date: 'July 2025',
    image: './assets/project_images/Portfolio_Frontend.png',
  ...
  },
  {
    ...
    date: 'July 2025',
    image: './assets/project_images/Portfolio_Contact_API.png',
    video: '',
  ...
  },
  {
    ...
    date: 'Aug 2025',
    image: './assets/project_images/AI_Chatbot_Image.png',
    ...
    tech: ['React + Vite', 'Typescript', 'C#', '.Net', 'Docker', 'PostgreSQL', 'Tailwind CSS', 'ShadcnUI', 'Tanstack Router', 'Gemini', 'Entity Frmework', 'JWT Authentication', 'Swagger/Swashbuckle', 'Github Actions'],
